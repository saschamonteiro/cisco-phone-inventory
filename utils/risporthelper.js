          ...
          if (items !== undefined) {
            items.forEach((item2) => {
              ...
              let phone = {
                ...
                ipAddress:
                  item2["ns1:IPAddress"][0] &&
                  item2["ns1:IPAddress"][0]["ns1:item"][0] &&
                  item2["ns1:IPAddress"][0]["ns1:item"][0]["ns1:IP"][0]
                    ? item2["ns1:IPAddress"][0]["ns1:item"][0]["ns1:IP"][0]
                    : "",
                dirNumber: item2["ns1:DirNumber"][0],
                loginUser:
                  typeof item2["ns1:LoginUserId"][0] === "string"
                    ? item2["ns1:LoginUserId"][0]
                    : "",
